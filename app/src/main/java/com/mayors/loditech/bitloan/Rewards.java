...
public class Rewards extends BaseDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtRewards2.setText(Double.toString(com.mayors.loditech.bitloan.Models.Rewards.rewards.getPoints()));
        GetAllVouchers();
    ...
    public void GetUser(){
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                com.mayors.loditech.bitloan.Models.Rewards.rewards = user.Rewards;
            }
